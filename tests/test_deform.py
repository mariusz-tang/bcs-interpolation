...
def test_vertex_scales_derivative() -> None:
    ...
    result = deform.bps.vertex_scales_derivative(dv_dt, start)
...
def test_patch_derivatives_function() -> None:
    ...
    result = deform.bps.patch_derivatives_function(
...
def test_vertex_rotations_derivative() -> None:
    ...
    dv_dt = finish.proxy.vertices - start.proxy.vertices
    result = deform.bps.vertex_rotations_derivative(dv_dt, start.proxy)
...
def test_unblended_patch_derivatives() -> None:
    ...
    result = deform.bps.unblended_patch_derivatives(
...
def test_blended_patch_derivatives() -> None:
    ...
    result = deform.bps.blended_patch_derivatives(
        dv_dt,
        dcoeffs_dt,
        start,
...
def test_from_bps_translation_only(t: float) -> None:
    ...
    m, d = deform.bps.bps_to_shape_space(start, finish, t, 2)
